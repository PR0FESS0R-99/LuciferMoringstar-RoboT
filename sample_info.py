...
ADMINS = [123456789, 'admin123', 987654321]
CHANNELS = [-1001483336810, -1001280344929, 'GD_FILMCLUB']
AUTH_USERS = []
AUTH_CHANNEL = None

# MongoDB information
DATABASE_URI = "mongodb://[Allu_ArjunROBOT:Allu_ArjunROBOT@]host1[:port1][,...hostN[:portN]][/[defaultauthdb]?retryWrites=true&w=majority"
DATABASE_NAME = 'Allu_ArjunROBOT'
